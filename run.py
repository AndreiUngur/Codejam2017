...
database_fields = {
    "player_stats":['player_id','full_name',
                'first_name','last_name','team','games_played','minutes','pull_up_shots_points_per_game',
...
@app.route('/team/<team>/players')
def get_team_players(team):
    query = text("select * from player_stats where team = :t")
